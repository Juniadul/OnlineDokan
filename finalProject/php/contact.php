...
<div class="heading">
   <h3>Contact us</h3>
   <p> <a href="home.php" style="text-decoration: none;">Home</a> / Contact </p>
</div>
...
<section class="reviews">
   ...
   <h1 class="title">People behind your expectations.</h1>

   <div class="box-container">

      <div class="box">
         <img src="../images/rahad.jpg" alt="">
         <div class="share">
      ...
      <div class="box">
         <img src="../images/juniadul.png" alt="">
         <div class="share">
            <a href="#" style="text-decoration: none;" class="fab fa-facebook-f"></a>
            <a href="#" style="text-decoration: none;" class="fab fa-twitter"></a>
            <a href="#" style="text-decoration: none;" class="fab fa-instagram"></a>
         ...
         <h3>Md Juniadul Islam</h3>
      </div>

      <div class="box">
         <img src="../images/apon.jpg" alt="">
         <div class="share">
         <a href="#" style="text-decoration: none;" class="fab fa-facebook-f"></a>
            <a href="#" style="text-decoration: none;" class="fab fa-twitter"></a>
            <a href="#" style="text-decoration: none;" class="fab fa-instagram"></a>
